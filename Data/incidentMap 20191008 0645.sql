...
-- Дата скрипта: 08.10.2019 6:45:40
-- Версия сервера: 14.00.2027
--
...
AS
  ...
  BEGIN
    SELECT
     ...
     ,i.pointY
     ,i.id_kn, k.knName
     ,i.id_hd, h.hdName, h.hdImage
     ,i.id_us, u.usFio, u.usRang
     ,i.id_rg, r.rgName
    FROM incident i
...
GO
INSERT dbo.incident(id_inc, ncDate, ncSubj, ncNotes, closeDate, ncClosed, ncVerdict, ncAdres, pointX, pointY, id_kn, id_hd, id_us, id_rg) VALUES (2, '2019-10-07', 'ДТП', 'Нарушение ПДД п.26.1.1 - 26.1.3', NULL, CONVERT(bit, 'False'), NULL, 'перекресток по ул. Полежаева, на пересечении с ул. Ккапуцинов', 52.9186421089, 30.9185321389, 1, 2, 1, 2)
INSERT dbo.incident(id_inc, ncDate, ncSubj, ncNotes, closeDate, ncClosed, ncVerdict, ncAdres, pointX, pointY, id_kn, id_hd, id_us, id_rg) VALUES (3, '2019-10-07', 'ывап ваып ваып ывап выап', 'чыва пывпвыап', '2019-10-07', CONVERT(bit, 'True'), 'x;ldfj lkdjfg l;djsgl; djld;jf gl;s', 'ап выап ваып', 52.9151790947, 30.9134573995, 1, 1, 1, 1)
INSERT dbo.incident(id_inc, ncDate, ncSubj, ncNotes, closeDate, ncClosed, ncVerdict, ncAdres, pointX, pointY, id_kn, id_hd, id_us, id_rg) VALUES (5, '2019-10-07', 'dfglhd;flkh;fdlghk', ';lksd ;lkd;fgk ;s''gk ', NULL, CONVERT(bit, 'False'), NULL, '', 52.9155811818, 30.9102494775, 1, 1, 1, 1)
GO
